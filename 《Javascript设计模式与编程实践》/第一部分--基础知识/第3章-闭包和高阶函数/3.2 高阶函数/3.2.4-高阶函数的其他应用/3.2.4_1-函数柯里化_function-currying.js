...
// 假设我们要编写一个计算每月开销的函数。在每天结束之前，我们都要记录今天花掉了多少钱。如果在
// 每个月的前 29 天，我们都只是保存好当天的开销，直到第 30 天才进行求值计算，这样就达到了
// 我们的要求。虽然下面的 cost 函数还不是一个 currying 函数的完整实现，但有助于我们了解
// 其思想。
(function() {
    let cost = (function () {
        let args = [];
...
// 接下来我们编写一个通用的 functioin currying() {}, 此函数接受一个参数，即将要被 
